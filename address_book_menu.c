 ...
 * 1b. Prompt user to enter the target to search, stored its corresponding serial No.
 *
...
Status edit_contact (AddressBook *address_book) {
    ...
    EDIT_BY:
        ...
        if (editBy == 0) {
            return e_back; // return back to prev. menu
        }
        ...
        switch (editBy) {
            ...
            case 1: {
                ...
                for (int rowfieldIndex = 0; rowfieldIndex < (address_book->count); rowfieldIndex++) {
                    ...
                    if (strncmp((const char *) ((address_book->list) + rowfieldIndex)->name,
                                targetName, NAME_LEN) == 0) {
                        targetSi = ((address_book->list) + rowfieldIndex)->si_no;
                        break;
                    }
                }
                break;
            ...
            case 2: {
                ...
                for (int rowfieldIndex = 0; rowfieldIndex < (address_book->count); rowfieldIndex++) {
                    ...
                    if (strncmp((const char *) ((address_book->list) + rowfieldIndex)->phone_numbers,
                                targetPhone, NUMBER_LEN) == 0) {
                        targetSi = ((address_book->list) + rowfieldIndex)->si_no;
                        break;
                    }
                }
            ...
            case 3: {
                ...
                for (int rowfieldIndex = 0; rowfieldIndex < (address_book->count); rowfieldIndex++) {
                    ...
                    if (strncmp((const char *) ((address_book->list) + rowfieldIndex)->email_addresses,
                                targetPhone, EMAIL_ID_LEN) == 0) {
                        targetSi = ((address_book->list) + rowfieldIndex)->si_no;
                        break;
                    }
                }
        ...
        //  3c assign the contact list pointer to the entry that has same serial number
        for (int rowfieldIndex = 0; rowfieldIndex < (address_book->count); rowfieldIndex++) {
        ...
        printf(": S.No : Name                             : Phone No                         : Email ID                           :\n");
        printf("=====================================================================================================================\n");
        printf(": %d   : %-33s : %-33s : %-33s :\n", listPtr->si_no, listPtr->name[0], listPtr->phone_numbers[0], listPtr->email_addresses[0]);
        printf("=====================================================================================================================\n");
        targetSi = get_option(NUM, "\nSelect a Serial Number (S.No) to Edit: ");

        ch = get_option(CHAR, "Press: [s] = Select, Press: [q] | Cancel: ");
        if (ch == 'q') {
            goto EDIT_BY;
        }
        ...
        do {
            ...
            printf("2. Phone No 1 : %-32s", listPtr->phone_numbers[0]);
            for (int phonefieldIndex = 1; phonefieldIndex < PHONE_NUMBER_COUNT; phonefieldIndex++) {
                ...
                // display        2 ...
                //                3 ...etc.
                if (strncmp(listPtr->phone_numbers[phonefieldIndex], "", EMAIL_ID_LEN - 1) != 0) {
                    printf("\n%13d : %-32s", phonefieldIndex + 1, listPtr->phone_numbers[phonefieldIndex]);
                }
            }


            // display email address
            printf("\n3. Email ID 1 : %-32s", listPtr->email_addresses[0]);
            for (int emailfieldIndex = 1; emailfieldIndex < EMAIL_ID_COUNT; emailfieldIndex++) {

                if (strncmp(listPtr->email_addresses[emailfieldIndex], "", EMAIL_ID_LEN - 1) != 0) {
                    printf("\n%13d : %-32s", emailfieldIndex + 1, listPtr->email_addresses[emailfieldIndex]);
                }
           ...
           // printf("4. Serial No\n");
            ...
            switch (editBy) {
                ...
                case 1: {
                    ...
                    char* target = malloc(sizeof(char) * NAME_LEN);
