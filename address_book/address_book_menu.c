...
Status edit_contact (AddressBook *address_book) {
    ...
    do {
        ...
        if (editBy == 0) {
            return e_success; // return back to prev. menu
        }
        ...
        // step 2, 3
            ...
            printf("\n  %d   : %33s : %33s : %33s :\n", listPtr->si_no, *(listPtr->name), listPtr->phone_numbers[0], listPtr->email_addresses[0]);
        ...
        do {
            ...
            printf("\n1. Name       : %32s", listPtr->name[0]);

            // display phone number
            printf("\n2. Phone No 1 : %-32s", listPtr->phone_numbers[0]);
            for (int phonefieldIndex = 1; phonefieldIndex < PHONE_NUMBER_COUNT; phonefieldIndex++) {
                ...
                // display        2 ...
                //                3 ...etc.
                if (strncmp(listPtr->phone_numbers[phonefieldIndex], NULL, EMAIL_ID_LEN - 1) != 0) {
            ...
            for (int emailfieldIndex = 1; emailfieldIndex < EMAIL_ID_COUNT; emailfieldIndex++) {
                ...
                if (strncmp(listPtr->email_addresses[emailfieldIndex], NULL, EMAIL_ID_LEN - 1) != 0) {
            ...
            if ( editBy == 1 || editBy == 2 || editBy == 3) {
                  edit_helper(listPtr, editBy);
                  break;
            }

            else if (editBy == 4 || editBy == 0) {
                // do nothing if user attempt to edit serial no
                return e_back;
            }
